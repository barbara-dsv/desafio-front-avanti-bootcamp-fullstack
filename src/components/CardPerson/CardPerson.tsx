...
function CardPerson({ person }: CardPersonProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-3">
        <p className="text-lg font-bold text-gray-900">{person.nome}</p>
      ...
      <div className="flex gap-2 mt-5">
        {loggedUserId === String(person.id) && (
          <button
            ...
            className="w-full text-center text-[15px] font-semibold text-blue-600 bg-blue-50 px-2.5 py-2 rounded-full hover:bg-blue-100 transition"
          >
            Editar
          </button>
        )}
        ...
        {loggedUserId === String(person.id) && (
          <button
            ...
            className="w-full text-center text-[15px] font-semibold text-red-600 bg-red-50 px-2.5 py-2 rounded-full hover:bg-red-100 transition"
          >
            Deletar
          </button>
        )}
